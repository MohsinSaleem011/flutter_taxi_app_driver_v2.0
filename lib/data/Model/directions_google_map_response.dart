...
DirectionsGoogleMapResponse directionsGoogleMapResponseFromJson(String str) => DirectionsGoogleMapResponse.fromJson(json.decode(str));

String directionsGoogleMapResponseToJson(DirectionsGoogleMapResponse data) => json.encode(data.toJson());

class DirectionsGoogleMapResponse {
  DirectionsGoogleMapResponse({
  ...
  factory DirectionsGoogleMapResponse.fromJson(Map<String, dynamic> json) => DirectionsGoogleMapResponse(
