...
class BankCard extends StatelessWidget {
  ...
  const BankCard({Key? key, required this.card}) : super(key: key);
                        ...
                        children: <Widget>[
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Text(
                                  ...
                                  textAlign: TextAlign.left,
                                  style: TextStyle(
                                      color: card.bgAsset == 'image/icon/bg_purple_card.png' || card.bgAsset == 'images/bg_blue_card.png' ? Colors.grey : Colors.black,
                          ...
                          Padding(
                            ...
                            child: Text(
                              ...
                              textAlign: TextAlign.left,
                              style: TextStyle(
                                  color: card.bgAsset == 'image/icon/bg_purple_card.png' || card.bgAsset == 'images/bg_blue_card.png' ? Colors.grey : Color(0xFF253C70),
...
class BankCardModel {
  ...
  BankCardModel(this.bgAsset,this.cardType, this.name, this.accountNumber, this.validDate,
      this.balance);
}
